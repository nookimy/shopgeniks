...
echo '  <div class="product__main-content js_shop_id js_shop">
            <h1 class="product__title page__heading3 page__title">'.$result["name"].'</h1>';

foreach($result["img"] as $img)
{
    echo '      <div class="card product__img-container">
                  <picture>
                      <source media="(min-width: 1170px)" srcset="'.$img["vs"]["product_d_3x"].' 3x, '.$img["vs"]["product_d_2x"].' 2x, '.$img["vs"]["product_d_1x"].'">
                      <img class="product__img"         src="'.$img["vs"]["product_m_1x"].'" 
                                                          srcset="'.$img["vs"]["product_m_3x"].' 3x, '.$img["vs"]["product_m_2x"].' 2x, '.$img["vs"]["product_m_1x"].'"
                                                             alt="'.$img["alt"].'"
                                                           title="'.$img["title"].'"
                                                        image_id="'.$img["id"].'">
                  </picture>
...
echo '      <section class="product-information product__information">
...
echo $this->get('id_description',
    'shop',
    $result
);

echo $this->htmleditor('<insert name="show_block_rel" module="shop" count="99" images="1">');
