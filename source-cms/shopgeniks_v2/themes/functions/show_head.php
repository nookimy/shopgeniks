...
{
    echo "\n".'    <link rel="stylesheet" href="'.BASE_PATH.File::compress('css/jquery.fancybox.min.css', 'css').'" type="text/css" media="screen" title="stylesheet">';
}
...
echo $this->functions('show_keywords', array());
echo '">';
